...
Required sections, in order, for `CLAUDE.md` / `AGENTS.md`. The agent fills in each section's content using SPEC.md, project state, and the generated command surface.
