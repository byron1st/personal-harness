...
2. If neither exists, ask the user with `AskUserQuestion` which agent file they want. Frame the choice as: "Which AI coding agent will primarily use this repo? Claude Code → CLAUDE.md, Codex / other agents → AGENTS.md."
...
Use `AskUserQuestion` with two options: "Personal" and "Work". The answer drives:
