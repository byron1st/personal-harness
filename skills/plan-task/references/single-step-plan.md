...
A single-step plan is one markdown file describing the full implementation of a task. Use this format when `plan-task` is operating in **single-step** mode (the default).
