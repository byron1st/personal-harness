...
2. If neither exists, ask the user which agent file they want. Frame the choice as: "Which AI coding agent will primarily use this repo? Claude Code → CLAUDE.md, Cursor / Codex / other agents → AGENTS.md."
