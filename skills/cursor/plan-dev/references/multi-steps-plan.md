...
- "Do the main plan's Markdown links match the sub-plan filenames I will write?" Verify each link before presenting the plan for approval. After writing the files in the persistence step, double-check that every link resolves.
