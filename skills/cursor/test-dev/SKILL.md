...
3. **Mutation tooling**: find the project's mutation target (typical: `make test-mutation`). If no tooling is configured, ask the user how to proceed (skip Phase 3 / nominate a command / install a standard tool).
