---
name: summarize-week
description: Write a weekly coding summary in Obsidian by reading the week's Daily notes, following the linked Plan and Research documents, and synthesizing a narrative. Takes an ISO week (`YYYY-WNN`) or any date within the target week. Output is saved to `51. Weekly/YYYY-WNN.md`.
---
