...
### 3. Multi-steps: each step runs in a sub-agent
...
The sub-agent prompt and return contract are defined in [references/multi-steps-implement.md](references/multi-steps-implement.md).
