...
- "Do the main plan's Markdown links match the sub-plan filenames I will write?" Verify each link before passing the plan to `ExitPlanMode`. (The post-write re-check belongs to SKILL.md's persistence step.)
