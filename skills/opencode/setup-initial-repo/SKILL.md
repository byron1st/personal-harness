...
2. If neither exists, ask the user with the question tool which agent file they want. Frame the choice as: "Which AI coding agent will primarily use this repo? Claude Code → CLAUDE.md, OpenCode / Codex / other agents → AGENTS.md."
...
Use the question tool with two options: "Personal" and "Work". The answer drives:
...
- The agent file (`AGENTS.md` and legacy `CLAUDE.md` when present) is in **English**, regardless of conversation language.
