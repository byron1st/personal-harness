...
The Makefile is the single source of truth for executable commands in the repo. Every command quoted from the agent file (`AGENTS.md` and legacy `CLAUDE.md` when present) must back to a target listed here.
