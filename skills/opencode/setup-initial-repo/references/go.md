...
Project-local Go conventions for this repository. The agent file (`AGENTS.md` and legacy `CLAUDE.md` when present) links here so an AI coding agent loads only the prescriptive rules and not the rationale.
