...
- **Find the entry point**: route, handler, CLI command, or event listener where the relevant flow begins. Use the project's structure (often in `AGENTS.md` or legacy `CLAUDE.md` when present) to orient yourself.
