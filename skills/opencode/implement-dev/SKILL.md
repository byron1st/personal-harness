---
name: implement-dev
description: Execute a plan-dev implementation plan with TDD, verification, TODO updates, and repository-local implementation reports under docs/agents. In multi-steps mode, use OpenCode subagents via the Task tool for each step. Use when the user asks to implement a saved single-step or multi-step plan.
---
...
1. The completion report (including a `## Manual Verification` checklist) has been written under `docs/agents/dev` by the subagent.
