...
Repository `AGENTS.md` instructions and legacy `CLAUDE.md` when present override bundled defaults, but they do not replace this required read. Record every convention file consulted and any de facto fallback used in the completion report's `## Summary`.
