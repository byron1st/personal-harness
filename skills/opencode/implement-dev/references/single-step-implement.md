...
If the implementation changed public APIs, commands, architecture, or setup steps, update `AGENTS.md` / legacy `CLAUDE.md` when present / `README.md`. Preserve existing section structure; update only content that is now stale.
