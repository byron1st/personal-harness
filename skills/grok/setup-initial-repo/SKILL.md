...
2. If neither exists, ask the user with `ask_user_question` which agent file they want. Frame the choice as: "Which AI coding agent will primarily use this repo? Claude Code → CLAUDE.md; Grok Build / Codex / Cursor → AGENTS.md."
...
Use `ask_user_question` with two options: "Personal" and "Work". The answer drives:
