---
name: dev-loop
description: "Drive an approved single-step plan through implement/test/review/(triage-fix) until READY_TO_COMMIT, checkpointing to a LOOP file. Use when asked to run a saved plan end to end as a loop. Requires Acceptance Contract + Authority Boundaries."
---
