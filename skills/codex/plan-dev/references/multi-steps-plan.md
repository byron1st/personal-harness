...
- "Do the main plan's wikilinks match the sub-plan filenames I will write?" — Verify each link before presenting the plan for Codex approval. After writing the files in the persistence step, double-check that every wikilink resolves.
